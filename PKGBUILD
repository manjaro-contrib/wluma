...
build() {
    ...
    # marked-man pins marked 12 while arch ships 14, which fails with
    # "text.trim is not a function": https://github.com/kapouer/marked-man/issues/41
    # README.md is still installed, so only the man page is lost.
}
